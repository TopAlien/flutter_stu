...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<CardListEntity>[] is M) {
      return data.map<CardListEntity>((Map<String, dynamic> e) =>
          CardListEntity.fromJson(e)).toList() as M;
    }
    if (<PostEntity>[] is M) {
    ...
    if (<TodoEntity>[] is M) {
      return data.map<TodoEntity>((Map<String, dynamic> e) =>
          TodoEntity.fromJson(e)).toList() as M;
    }
    if (<UserEntity>[] is M) {
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (CardListEntity).toString(): CardListEntity.fromJson,
