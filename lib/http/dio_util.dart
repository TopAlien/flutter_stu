...
import 'package:flutter_card/http/dio_interceptors.dart';
...
class DioUtil {
  ...
  /// 请求的URL前缀
  static String BASE_URL = 'https://mock.apifox.com/m1/3887514-3521737-default';
  ...
  Future<T> request<T>(
    ...
    try {
      ...
      final apiResponse = BaseResponseEntity<T>.fromJson(response.data);
